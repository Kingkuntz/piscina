...
/*Comprueba si el destino y el origen no son
NULL
...
Si se solapan,
empezamos por el final del bloque de memoria
...
Podemos copiar hacia delante desde el inicio del bloque de memoria hasta el 
final.*/
